...
class _$StoreProfileImpl implements _StoreProfile {
  ...
  @override
  int get hashCode => Object.hash(runtimeType, storeName, storeAddress,
      storeTaxId, storePhone, receiptFooter, lowStockThreshold);
...
abstract class _StoreProfile implements StoreProfile {
  const factory _StoreProfile(
      ...
      final int lowStockThreshold}) = _$StoreProfileImpl;
